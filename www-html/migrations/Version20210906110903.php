...
final class Version20210906110903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Generate demo data
        $this->addSql("insert into author(name) select 'Author#'||' '||i::text from generate_series(1, 10000) s(i);");
        $this->addSql("insert into book(name) select 'Book#'||' '||i::text from generate_series(1, 10000) s(i);");
        $this->addSql("insert into book_author(book_id,author_id) select i::int,(10001 - i::int) from generate_series(1, 10000) s(i);");
    }
